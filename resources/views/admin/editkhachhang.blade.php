...
@section('title')
Chỉnh sửa thông tin khách hàng | Quản trị Admin
@endsection
@section('title2')
...
<div class="row">
    <div class="col-md-12">
      ...
      <div class="tile">
        ...
        <div class="tile-body">
          <form class="row" action="{{route('admin.khachhang.update',$user->id)}}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            ...
            <a class="btn btn-cancel" href="{{route('admin.khachhang')}}">Hủy bỏ</a>
