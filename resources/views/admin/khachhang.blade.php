...
@section('title')
Danh sách khách hàng | Quản trị Admin
@endsection
@section('title2')
        ...
        <div class="tile-body">
          ...
          <div class="row element-button">
            <div class="col-sm-2">
              ...
              <a class="btn btn-add btn-sm" href="{{route('admin.khachhang.them')}}" title="Thêm"><i class="fas fa-plus"></i>
          ...
          <table class="table table-hover table-bordered js-copytextarea" cellpadding="0" cellspacing="0" border="0"
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        @if($kh->avatar)
                            <img class="img-card-person" src="{{asset('storage'). '/'. $kh->avatar}}" alt="">
                        @else
                    ...
                    <td class="table-td-center d-flex">
                        <a href="{{ route('admin.khachhang.edit',$kh->id) }}" class="btn btn-primary btn-sm edit" type="button" title="Sửa" id="show-emp"
