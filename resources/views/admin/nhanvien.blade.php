  ...
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/jquery-confirm/3.3.2/jquery-confirm.min.css">
    ...
    <style>
        .icon-placeholder {
            ...
            border: 1px dashed #ccc; /* Đường viền */
        ...
        <div class="tile-body">
          ...
          <div class="row element-button">
            <div class="col-sm-2">
              ...
              <a class="btn btn-add btn-sm" href="{{route('admin.nhanvien.them')}}" title="Thêm"><i class="fas fa-plus"></i>
                Tạo mới nhân viên</a>
                @if(session('message'))
          ...
          <table class="table table-hover table-bordered js-copytextarea" cellpadding="0" cellspacing="0" border="0"
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        @if($nv->avatar)
                            <img class="img-card-person" src="{{asset('storage'). '/'. $nv->avatar}}" alt="">
                        @else
                            <span class="icon-placeholder"> <!-- Bạn có thể sử dụng thẻ <i> cho icon font nếu cần -->
                                <i class="fas fa-image "></i> <!-- Ví dụ sử dụng Font Awesome -->
                            </span>
                        @endif
                    </td>
                    <td>{{$nv->address}}</td>
                    ...
                    <td class="table-td-center d-flex">
                        <form action="{{route('admin.nhanvien.destroy',$nv->id)}}" method="post">
                            @csrf
                            @method('DELETE')
                        ...
                        <a href="{{ route('admin.nhanvien.edit',$nv->id) }}" class="btn btn-primary btn-sm edit" type="button" title="Sửa" id="show-emp"
