            ...
            <div class="col-lg-12 text-center">
                <div class="breadcrumb__text">
                    ...
                    <div class="breadcrumb__option">
                        ...
                        <a href="{{route('product.category',$nameCategories->id)}}">{{$nameCategories->name}}</a>
                ...
                <div class="product__details__pic">
                    <div class="product__details__pic__item">
                        <img class="product__details__pic__item--large"
                            src="{{asset('storage'). '/'.$productDetail->image}}" alt="">
                    </div>
                </div>
            </div>
            <div class="col-lg-6 col-md-6">
                <div class="product__details__text">
                    ...
                    <div class="product__details__rating">
                        ...
                        <span>({{$productDetail->luotxem}} views)</span>
                    </div>
                    ...
                    @if ($productDetail->quantity == 0)
                        <button class="secondary-btn" disabled>HẾT HÀNG</button>
                    @else
                        <a href="{{route('product.addToCart',$productDetail->Product_id)}}" class="primary-btn">ADD TO CART</a>
                    @endif
