...
<body>
    ...
    <div class="humberger__menu__wrapper">
        ...
        <nav class="humberger__menu__nav mobile-menu">
            <ul>
                <li class=""><a href="{{route('client')}}">Trang chủ</a></li>
                <li><a href="{{route('product.listproducts')}}">Cửa hàng</a></li>
                <li><a href="#">Trang</a>
                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="header__top__right">
                            ...
                            <div class="header__top__right__auth">
                                ...
                                <a href="{{route('admin')}}"><i class="fa fa-user"></i> Admin Dashboard</a>
                                @endif
                                <a href="{{route('logout')}}"><i class="fa fa-user-times"></i> Logout</a>
                                @endif
                            </div>
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-lg-3">
                    <div class="header__logo">
                        <a href="{{route('admin')}}"><img src="{{asset('client/img/logo.png')}}" alt=""></a>
                    </div>
                </div>
                <div class="col-lg-6">
